...
main(int argc, char **argv)
{
	...
	//op_mode = 1; 
	//input_file = "hpy414_encryptme_pub.txt";
	//output_file = "encrypted_testfile.txt";
	//key_file = "hpy414_public.key";
	
	op_mode = 0; 
	input_file = "encrypted_testfile.txt";
	output_file = "decrypted_testfile.txt";
	key_file = "hpy414_private.key";
